...
impl FormType {
    ...
    pub fn category(&self) -> FilingCategory {
        match self.base_type() {
            FormType::TenK | FormType::TenQ | FormType::TwentyF => {
            ...
            | FormType::DefM14A
            | FormType::DefC14A
            | FormType::DefC14C => FilingCategory::ProxyStatement,
            FormType::S1
            | FormType::S3
            | FormType::S4
            | FormType::S8
            ...
            FormType::Form3 | FormType::Form4 | FormType::Form5 => {
                FilingCategory::InsiderTrading
            }
            FormType::ThirteenFHr | FormType::ThirteenFNT => {
                FilingCategory::InstitutionalHoldings
            }
            FormType::FortyF | FormType::FortyFR12B | FormType::FortyFR12G => {
            ...
            FormType::NT10K | FormType::NT10Q | FormType::NT11K | FormType::NT15D2 => {
    ...
    pub fn frequency(&self) -> FilingFrequency {
        match self.base_type() {
            FormType::TenK | FormType::TwentyF | FormType::ElevenK => {
...
mod tests {
    ...
    fn test_category() {
        ...
        assert_eq!(
            FormType::EightK.category(),
            FilingCategory::CurrentReport
        );
        assert_eq!(
            FormType::Form4.category(),
            FilingCategory::InsiderTrading
        );
    }
