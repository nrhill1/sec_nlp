...
class SummaryPipeline(BasePipeline[SummaryConfig, SummaryResult]):
    ...
    def __init__(self, config: SummaryConfig, out_path: Path | None = None, dl_path: Path | None = None) -> None: ...
    ...
    def _upsert_texts(self, collection_name: str, texts: list[str], metadata: list[dict[str, Any]] | None = None, ids: list[str] | None = None) -> list[str]: ...
